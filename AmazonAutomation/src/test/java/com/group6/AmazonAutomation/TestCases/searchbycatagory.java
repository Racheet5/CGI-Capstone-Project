...
public class searchbycatagory {
        ...
        try {
            ...
            for (String keyword : searchKeywords) {
                ...
                if (isInStock) {
                    ...
                    String screenshotPath = captureAndAttachScreenshot(keyword);
    ...
    private String captureAndAttachScreenshot(String keyword) throws IOException {
        ...
        String timestamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());
        File destfile = new File("./screenshots/search/" + keyword + timestamp + ".png");
        FileUtils.copyFile(sourcefile, destfile);
        String filePath = new String("./screenshots/search/" + keyword + timestamp + ".png" );
        return filePath;
    }
}