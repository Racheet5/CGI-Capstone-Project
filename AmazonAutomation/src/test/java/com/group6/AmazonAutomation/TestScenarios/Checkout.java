...
public class Checkout {
  ...
  public void f(String n, String s) throws InterruptedException, IOException {
      ...
      //Address stored by default is picked
      ...
      if (driver.findElement(messageLabel).isDisplayed()) {
          System.out.println("Order placed successfully!");
          test.pass("Order Success page is displayed");
          test.addScreenCaptureFromPath("./checkout/"+screenshot);
      } else {
          System.out.println("Order failed!");
          test.fail("Order not successfully placed");
      	}
      extent.flush();
	  }
  ...
  @DataProvider
	public String[][] dp() throws IOException {
		  ...
		  File file1=new File("./checkoutdata.xlsx");
